			...
			while($faqD = $faq_data->fetch_assoc()) {
				$leftRow .= '<div class="card">
                    <div class="card-header" id="Lheading'.$faqD["faq_id"].'">
                      <h5 class="mb-0"> <a href="javascript:void(0);" class="collapsed" data-toggle="collapse" data-target="#L'.$faqD["faq_id"].'" aria-expanded="false" aria-controls="L'.$faqD["faq_id"].'">'.$faqD["faq_title"].'</a> </h5>
                    </div>
			...
			while($faqD2 = $faq_data2->fetch_assoc()) {
				$rightRow .= '<div class="card">
                    <div class="card-header" id="Rheading'.$faqD2["faq_id"].'">
                      <h5 class="mb-0"> <a href="javascript:void(0);" class="collapsed" data-toggle="collapse" data-target="#R'.$faqD2["faq_id"].'" aria-expanded="false" aria-controls="R'.$faqD2["faq_id"].'">'.$faqD2["faq_title"].'</a> </h5>
                    </div>
