...
$acc_type = Trim(stripslashes($_POST['acc_type'])); 
$acc_cur = Trim(stripslashes($_POST['acc_cur'])); 
$acc_fmode = Trim(stripslashes($_POST['acc_fmode'])); 
...
try {
	...
	$mail->Subject  = "Customer Account Upgrade Request";
	...
	--------------------------
	<br/>
	New Currency Selected for account: $acc_cur
	<br/>
	--------------------------
	<br/>
	New Funding Mode Selected: $acc_fmode
	<br/>
	<br/>
	--------Stock Project 2017---------";
	$mail->MsgHTML($body);
