...
{    
	...
	{		
		...
		{		
			...
			/*$.post("imf-check.php", $("#reg-form").serialize())
				.done(function(data){
				$("#result").html(data);
			});*/
...
?>
<form name="form" method="post" action="transfers_new_EN_review.php"> 
...
<?php } ?>
<?php } ?>
<h4><span >International Monetary Funds Code</h4></span >
<input style="width:10%;" type="text" name="name" id="name" MAXLENGTH=3 />FSAP/AML/CFT/IMF
</div>
<br/>
