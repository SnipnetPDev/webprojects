...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-mini"><?php echo $short_name; ?></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="../../../img/logo.png" width="150px" height="" alt="<?php echo $site_title; ?>" /></span>
    </a>
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start notification -->
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> 1 new member joined today
                    </a>
                  </li>
                  <!-- end notification -->
                </ul>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="../../../<?php echo $image_src;  ?>" class="img-circle" alt="User Image">

                <p>
                <?php echo $_SESSION['usr_name']; ?> - Administrator<br/>
				</p>
