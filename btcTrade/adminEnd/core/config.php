...
/* App credentials. */
define('APP_URL', 'https://admin.your-website.tdl/');
...
define('KEY0', 'APP_USERNAME');
define('KEY1', 'API_KEY');

/* CoinPayments credentials. */
// PROVIDER: https://www.coinpayments.net/
define('COINP_private_key', 'private_key');
define('COINP_public_key', 'public_key');
