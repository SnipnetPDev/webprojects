...
{    
	...
	{		
		...
		{		
			...
			/*$.post("cot-check.php", $("#reg-form").serialize())
				.done(function(data){
				$("#result").html(data);
			});*/
...
?>
<form name="form" method="post" action="transfers_new_imf_check.php"> 
...
<?php } ?>
<?php } ?>
<h4><span >Cost of Transfer Code</h4></span>
COT/US/<input style="width:10%;" type="text" name="name" id="name" MAXLENGTH=4 />BG/17
</div>
<br/>
